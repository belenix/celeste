...
//            this.identity = identity;
        ...
        public String getDisplayName() throws HTTP.InternalServerErrorException, HTTP.NotFoundException, HTTP.GoneException, HTTP.UnauthorizedException, HTTP.ConflictException {
            return new HttpUtil.PathName(this.getURI().getPath().toString()).baseName();
        }
...
//                        this.getFile().setContentType(InternetMediaType.type(String.valueOf(p.getValue())));
    ...
    public interface Backend extends HTTP.Backend {
         ...
         */
        public WebDAV.Resource getResource(URI uri, HTTP.Identity identity) throws HTTP.InternalServerErrorException, HTTP.GoneException, /*HTTP.NotFoundException,*/ HTTP.UnauthorizedException;
    }
...
//        }
    ...
    public interface Resource extends HTTP.Resource {  
        ...
        throws HTTP.InternalServerErrorException, HTTP.NotFoundException, HTTP.UnauthorizedException, HTTP.GoneException, HTTP.ConflictException;
