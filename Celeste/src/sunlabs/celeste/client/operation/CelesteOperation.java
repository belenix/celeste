...
public interface CelesteOperation extends Serializable {
    ...
    /**
     * Get the {@link TitanGuid} of the {@link VersionObject} of the file that this operation applies to.
     * <p>
     * By convention if this value is {@code null} or all zeros (deprecated) (See {@link TitanGuidImpl#ZERO}),
     * then this operation is to apply to the current version of the file.
     * </p>
     * @return the {@link TitanGuid} of the {@link VersionObject} of the file that this operation applies to.
     */
     ...
     * the corresponding privilege defined by the {@code CelesteACL.CelesteOps}
     * enumeration.
     * </p>
     *
