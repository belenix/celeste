...
//    /**
//     * A class to do basic URI/URL path manipulations.
//     *
//     */
//    private static class Pathname2 {
//        private Stack<String> path;
//
//        public Pathname2(String name) {
...
//        }
//        
//        public Pathname2(URI uri) {
//            this(uri.getPath());
//        }
//        
//        public Pathname2 head() {
//            StringBuilder result = new StringBuilder();
//            for (int i = 0; i < (this.path.size() - 1); i++) {
//                result.append("/").append(this.path.get(i));
//            }
//            return new Pathname2(result.toString());
//        }
//        
//        public String tail() {
...
//        
//        /**
//         * Create a new PathName instance composed from this PathName and the given {@code name}.
//         * 
//         * @param name
//         * @return
//         */
//        public Pathname2 add(String name) {
//            Pathname2 newPathName = new Pathname2(this.toString()).add(new Pathname2(name));
//            return newPathName;
//        }
//        
//        public Pathname2 add(Pathname2 name) {
//            Pathname2 newPathName = new Pathname2(this.toString());
...
//                return "/";
//            
//            StringBuilder result = new StringBuilder(this.path.get(0).equals("") ? "/" : "");
//            String slash = "";
//            for (String p : this.path) {
//                if (!p.equals("")) {
...
//         * For example:
//         * <ul>
//         * <li>{@code head("/a/b/c")} returns {@code ""} (absolute paths contain the empty string as the first component).</li>
//         * <li>{@code head("a/b/c")} returns "a".</li>
//         * </ul>
//         * @return
//         */
//        public String head() {
...
//        }
        ...
        /**
         * Return the tail of this path, containing at most {@code length} components.
         * 
        ...
        public static class BinaryIterator {
            ...
            public BinaryIterator(int n) {
                this.n = n;
                this.reset();
            }
            
            public int value() {
                int result = n * numerator / denominator;
                return result;
            }
            ...
            public void signum(int signum) {
                this.denominator *= 2;
                this.numerator = this.numerator * 2 + signum;
            }
        }
        
        public static void main(String[] args) {
            PathName a = new PathName("/a/b/c/d/e/f/g/h/i/j/k/l/m/n/o");
